package com.techsessions.threads.e4locks.solution.reentrantlock;
...
class Engineer extends Thread {
    ...
    static ReentrantLock brickTowel = new ReentrantLock();
    ...
    private void addBrick() {
        ...
        System.out.println("Hold locks: " + brickTowel.getHoldCount());
        addConcretePounds(2);
        bricksOnWall++;
        brickTowel.unlock();
    }
